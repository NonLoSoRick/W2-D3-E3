...
{let starWarsCharacters = [{name: "Luke Skywalker"}, {name:"C-3PO"}, {name:"R2-D2"}, {name:"Darth Vader"}, {name:"Leia Organa"},{name:"Owen Lars"},{name:"Beru Whitesun lars"},
{name:"R5-D4"},{name:"Biggs Darklighter"},{name:"Obi-Wan Kenobi"}]
...
let crewWeights = [277,75,32,136,49,120,75,32,84,77];

while (index < crewWeights.length) {
  crewMass += crewWeights[index];
  index++;
}
